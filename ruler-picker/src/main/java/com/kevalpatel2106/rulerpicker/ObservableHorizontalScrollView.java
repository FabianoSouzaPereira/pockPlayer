...
final class ObservableHorizontalScrollView extends HorizontalScrollView{
    private static final long NEW_CHECK_DURATION = 1000L;

    long mLastScrollUpdateMills = -1;
    boolean mIsDefaultPosition = false;

    @Nullable
    private ScrollChangedListener mScrollChangedListener;
    private ScrollStartListener mScrollStartListener;
    ...
    public ObservableHorizontalScrollView(@NonNull final Context context,
                                          ...
                                          @NonNull final ScrollStartListener listenerDraw) {
        super(context);
        mScrollChangedListener = listener;
        mScrollStartListener = listenerDraw;
    }
    @Override
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(!mIsDefaultPosition){
            ...
            mScrollStartListener.onFinishedDrawScroll();
        }
    }
